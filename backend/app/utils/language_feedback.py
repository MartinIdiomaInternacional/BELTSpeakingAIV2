...
TEMPLATES = {
    ...
    "pt": {"title":"Relatório de Avaliação de Fala","intro":"Este relatório resume seu desempenho de fala alinhado ao QECR.","strengths":"Pontos Fortes","areas":"Pontos a Melhorar","next":"Próximas Etapas"},
    "fr": {"title":"Rapport d'Évaluation d'Expression Orale","intro":"Ce rapport résume vos performances orales alignées sur le CECR.","strengths":"Points forts","areas":"Axes d'amélioration","next":"Prochaines étapes"},
}

...
questions = {
    ...
    "A2": [
        "Can you describe your last holiday?",
        ...
        "Tell me about a celebration or festival in your country.",
        "What do you do to stay healthy?",
        "What kind of sports do you like?",
        "Describe a typical day at work or school.",
        "Talk about a time you had to make a choice.",
        "Tell me about your favorite book.",
        "What kind of transport do you use most often?",
        "Describe a city or town you like.",
        "What is your dream job and why?",
        "Talk about your favorite holiday tradition.",
        "Can you describe an object that is important to you?",
        "Tell me about a funny thing that happened recently.",
    ...
    "B1": [
        ...
        "What are some problems in your town and how can they be solved?",
        "Discuss why people enjoy traveling.",
        "Talk about a time you helped someone.",
        "What are the pros and cons of social media?",
        "Tell me about a new skill you want to learn and why.",
        "Describe a challenge you overcame.",
        "Talk about a tradition you think is important.",
        "How has technology changed the way you shop?",
        "What makes a good friend?",
        "Do you think it's important to protect the environment? Why?",
        "How do you usually prepare for a trip?",
        "Talk about a goal you have for the next five years.",
        "What is a job that is very important in society?",
    ...
    "B2": [
        "Explain how technology has changed the way we communicate.",
        "Do you think social media influences politics? Why?",
        "What are some common causes of stress, and how can people deal with it?",
        "Talk about a book or movie that changed your perspective.",
        "Discuss the importance of learning foreign languages today.",
        "Should governments spend more on the arts or science? Why?",
        "Do you believe that money can buy happiness? Explain.",
        "Talk about a time when you had to convince someone of your opinion.",
        "Is it better to live in a big city or a small town? Why?",
        "How can young people prepare for the future job market?",
        "Discuss the pros and cons of remote work.",
        "Do advertisements influence people's choices too much?",
        "What makes a good leader in your opinion?",
        "Do you think climate change can still be stopped? How?",
        "Talk about a difficult cultural difference you have experienced.",
        "Should public transport be free for everyone?",
        "How do movies and books affect our emotions?",
        "Explain why people enjoy extreme sports.",
        "Is online dating changing relationships? Explain your view.",
        "Discuss how tourism affects local cultures."
    ],
    "C1": [
        ...
        "Discuss the role of technology in shaping human relationships.",
        ...
        "How important is freedom of speech in modern society?",
        "Should space exploration be publicly funded? Why?",
        "Discuss the ethics of genetic engineering in humans.",
        "What role should art play in education?",
        "Talk about a law you believe should be changed and why.",
        "Is social inequality inevitable in every society?",
        "How does the media shape public opinion about important issues?",
        "Discuss whether animal testing should be banned completely.",
        ...
        "How important is emotional intelligence for success?",
        "Talk about a global issue that needs urgent attention.",
        "Should universities focus more on research or teaching?"
    ],
    "C2": [
        "If you were leading an international organization, how would you solve a global crisis?",
        "Is democracy the best form of government for all countries?",
        "What are the long-term consequences of technological dependence on society?",
        "Should advanced AI systems have rights? Why or why not?",
        "To what extent should cultural heritage be preserved in a fast-changing world?",
        "Can morality exist without religion? Discuss your view.",
        "How should nations address global wealth inequality?",
        "Is human progress always beneficial? Consider environmental costs.",
        "Should all scientific research be openly accessible to everyone?",
        "How do philosophical ideas shape political systems?",
        "Discuss whether a universal basic income would solve poverty.",
        "How can individuals balance personal freedom with social responsibility?",
        "Should medical resources be prioritized for younger patients in crises?",
        "What responsibilities do powerful nations have toward weaker ones?",
        "How might virtual reality change human interaction in the next 50 years?",
        "Should history be rewritten to correct past biases?",
        "Do international laws need to change to handle cyber warfare?",
        "Discuss the ethical dilemmas of cloning humans.",
        "Should space colonization be humanity's top priority?",
        "To what extent can art influence global political change?"
    ]
}
...
async def start_test():
    ...
    sessions[session_id] = {"questions_asked": 0, "answers": [], "current_level": "A1", "asked_questions": []}
    q = random.choice(questions["A1"])
    sessions[session_id]["asked_questions"].append(q)
